        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="right_menu">
                <div class="menu_search_btn">
                    <img src="{{ asset('frontendd/assets/')}}images/search_icon.png" alt="Search" class="img-fluid">
                </div>
                <ul>
                    <li>
                        <a class="menu_signin" href="#">
                            <span>
                                <img src="{{ asset('frontendd/assets/')}}images/cart_icon_black.png" alt="user" class="img-fluid">
                            </span>
                            <b>06</b>
                        </a>
                    </li>
                    <li>
                        <a class="admin" href="#">
                            <span>
                                <img src="{{ asset('frontendd/assets/')}}images/user_icon_black.png" alt="user" class="img-fluid">
                            </span>
                            admin
                        </a>
                    </li>
